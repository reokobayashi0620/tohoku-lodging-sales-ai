...
BUSINESS_SEEDS = (
    ...
    },
    {
        ...
        "source_url": "https://minpaku-miyagi.com/",
        "notes": "民泊運営代行。全国累計の運営実績を掲げ、清掃・メンテナンス手配にも対応。",
    },
    {
        ...
        "source_url": "https://www.minpaku-resort.com/sendai/",
        "notes": "仙台の民泊運営・清掃代行。設備不具合・緊急トラブル対応を案内。",
    },
    {
        "name": "HTP 民泊ホテル運営",
